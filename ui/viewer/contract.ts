...
export interface ViewerLike {
  ...
  /**
   * Чем показывать модель: её материалами ('file') или нашей глиной ('clay').
   * РЕЖИМ ПОКАЗА, не правка: родные материалы возвращаются на место, в файл не попадает
   * ничего (Правило 11).
   */
  setDisplayMaterial(mode: 'file' | 'clay'): boolean;
