 ...
 * (KHR_lights_punctual); ноль означает, что переключать нечего и кнопки быть не должно:
 * «свет из файла» у модели без источников — это темнота, а не замысел автора.
 *
...
export interface ViewerLike {
  ...
  /** Показать авторский свет или вернуть студийный. false = у модели своего света нет. */
  setLightMode(mode: 'studio' | 'file'): boolean;
