// ui/locales/ru.js — русский каталог строк интерфейса.
...
window.I18N_CATALOGS.ru = {
  ...
  'validator.blindSpots': ({ n, names }) =>
    `${n} ${window.I18n.plural(n, ['замечание', 'замечания', 'замечаний'])} `
    + `${window.I18n.plural(n, ['появилось', 'появились', 'появились'])} только потому, что валидатор не умеет читать ${names}. `
    + 'Это не дефекты модели',
  'sev.0': 'Ошибка',
