...
[![Версия](https://img.shields.io/badge/версия-0.0.10-orange)](#статус)
...
**0.0.10, ранняя разработка.** Ядро, веб-интерфейс и вьюер работают, набор тестов
зелёный. Настольное приложение ставится как обычная программа, терминал не нужен.
API может меняться.
