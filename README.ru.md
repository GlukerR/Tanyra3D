...
возможностей. Набор тестов зелёный: 2878 тестов, ни одного падения.

**Последний выпущенный тег — 0.1.1.** Ядро, веб-интерфейс и вьюер работают, набор тестов
зелёный на Node 20, 22 и 24. Настольное приложение ставится как обычная программа,
терминал не нужен. API может меняться.
