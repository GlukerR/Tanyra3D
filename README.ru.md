...
[![Версия](https://img.shields.io/badge/версия-0.1.0-orange)](#статус)
...
**0.1.0 — первый выпуск, который не стыдно показать.** Ядро, веб-интерфейс и вьюер
работают, набор тестов зелёный на Node 20, 22 и 24. Настольное приложение ставится как
обычная программа, терминал не нужен. API может меняться.
