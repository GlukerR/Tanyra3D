// addons/gltf/messages/en.d.mts — форма каталога для TypeScript. Сам каталог остаётся на
// JavaScript (en.mjs) и правится переводчиком напрямую (assistants/translate/): сделать
