...
export default {
  ...
  // Правило 10: человек видит его в метаданных и в проверке, а в подсказке оно
  // только мешает. Речь про результат: меньше отрисовок за кадр.
  ...
  // Число — часть языка (Правило 8): при одной текстуре «на них» и «они» врут,
