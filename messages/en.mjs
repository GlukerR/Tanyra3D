...
'option.safe.title': () => 'Safe optimizations',
  ...
  // Four sizes, four options in one group. The texts differ on purpose: the difference
  // between 4096 and 512 is not the number, it is what the model is good for afterwards.
  'option.resize-4096.title': () => 'Textures up to 4096',
  'option.resize-4096.description': () => 'Shrinks images larger than 4096 points on the longer side. The top setting: right when the model is examined up close — a large product, turned around and inspected.',
  'option.resize-4096.impact': () => 'Noticeably lighter only for models with very large textures. The difference is almost impossible to see up close.',
  'option.resize-2048.title': () => 'Textures up to 2048',
  'option.resize-2048.description': () => 'Shrinks images larger than 2048 points on the longer side. The usual choice for a website: nearly every platform recommends this size.',
  'option.resize-2048.impact': () => 'File and video memory drop about fourfold if the textures were 4096. On screen the difference shows only when zoomed in hard.',
  'option.resize-1024.title': () => 'Textures up to 1024',
  'option.resize-1024.description': () => 'Shrinks images larger than 1024 points on the longer side. For models seen from a distance or shown small: background, environment, an item in a product list.',
  'option.resize-1024.impact': () => 'A large saving in weight and video memory. Up close, small details and lettering on the texture get blurry.',
  'option.resize-512.title': () => 'Textures up to 512',
  'option.resize-512.description': () => 'Shrinks images larger than 512 points on the longer side. The smallest setting: for icons, small objects and very weak devices.',
  'option.resize-512.impact': () => 'The model becomes very light, but the textures get visibly coarse. Lettering and fine patterns stop being readable.',
